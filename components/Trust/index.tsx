    ...
    <section className={styles.trust} id="trust">
      <div className={styles.inner}>
        {TRUST_STATS.map((stat, i) => (
          <>
            {i > 0 && <div key={`div-${i}`} className={styles.divider} />}
            <div
              key={stat.label}
      ...
      <div className={styles.credWallWrap}>
        <div className={`${styles.credWallHeader} reveal-up`}>
          <span className={styles.credWallLabel}>Certifikuar dhe Akredituar nga</span>
          <div className={styles.credWallLine} />
          <span className={styles.credWallCount}>05 / Institucione</span>
        </div>
